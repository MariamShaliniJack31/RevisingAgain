...
@CucumberOptions(features = { "src/test/resources/features/EPIC_117_GeneralCVSubmit" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@JobApplyWithPRSGeneralCVformWithEnglishJob,@JobApplyWithPRSGeneralCVformWithFrenchJob,@CCandPRSEnableJobWithCountryOfAfrica,@VerifyandSignInOnSubmitCVFormPage,@PrepopulatedDatainApplyCVPag,@VerifySignIn,@UploadCVCheckExistingDetailsUseGoBacklink,@CCandPRSformEnableWithUploadCV" })

public class EPIC_117_GeneralCVSubmit_Michaelpagerunner extends TestBase {
