...
@CucumberOptions(features = { "src/test/resources/features/EPIC_97_CVUpload" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@CVUploadForEnglishJOb,@CVFrencJObUpload" })

public class EPIC_97_CVUpload_Michaelpagerunner extends TestBase {
