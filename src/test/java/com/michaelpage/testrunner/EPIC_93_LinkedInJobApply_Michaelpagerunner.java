...
@CucumberOptions(features = { "src/test/resources/features/EPIC_93_LinkedInJobApply" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@FetchDetailsFromLinkedinNoexp,@ApplyCCjobwithLinkedin,@ApplyCCjobwithLinkedin,@ApplywithLinkedin,@ApplyjobwithLinkedin,@FetchDetailsFromLinkedin" })

public class EPIC_93_LinkedInJobApply_Michaelpagerunner extends TestBase {
