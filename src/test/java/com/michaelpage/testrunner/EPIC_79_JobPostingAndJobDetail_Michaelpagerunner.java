...
@CucumberOptions(features = { "src/test/resources/features/EPIC_79_JobPostingAndJobDetail" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@JobInformation,@ReApplyTheAppliedJob,@InactiveAndNotCientAuth,@EmailJobFrenchLanguage,@JobSavedAndUnSaved,@EmailJob,@ViewAndsaveSimilarJobs" })

public class EPIC_79_JobPostingAndJobDetail_Michaelpagerunner extends TestBase {
