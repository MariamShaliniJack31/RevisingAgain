...
@CucumberOptions(features = { "src/test/resources/features/EPIC_81_Homepage" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@CountOfSavedJob,@HomePageUI,@VerifyFeaturedEmployer,@VerifyPopularArticle,@VerifyBlogContent" })

public class EPIC_81_Homepage_Michaelpagerunner extends TestBase {
