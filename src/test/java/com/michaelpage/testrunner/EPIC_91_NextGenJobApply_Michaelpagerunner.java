...
@CucumberOptions(features = { "src/test/resources/features/" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@PRSJobApply,@VerifyCCEnableJob,@JobAppllywithCVwithValidNinvalid,@CreatenewaccountJobAppllywithCV" })

public class EPIC_91_NextGenJobApply_Michaelpagerunner extends TestBase {
