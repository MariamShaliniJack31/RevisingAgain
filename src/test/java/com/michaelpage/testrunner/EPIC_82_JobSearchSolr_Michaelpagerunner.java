...
@CucumberOptions(features = { "src/test/resources/features/EPIC_82_JobSearchSolr" }, glue = {
		"com.michaelpage.stepdefinitions" }, monochrome = true, dryRun = false, tags = {
				"@VerifyJobSearch,@JobLocationFilters,@JobsearchFilters,@JobSolrSearchh,@JobSolrSearch,@VerifyMinMaxValueAftersearchingJob,@VerifyJobTitleThenGoBackJobListingPage" })

public class EPIC_82_JobSearchSolr_Michaelpagerunner extends TestBase {
